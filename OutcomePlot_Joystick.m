...
function OutcomePlot_Joystick(AxesHandle, Action, varargin)
%% 
...
switch Action
    case 'init'
        ...
        set(AxesHandle,'TickDir', 'out','YLim', [-3, 2], 'YTick', [-2 -1 0 1],'YTickLabel', {'Tone B_A' 'Tone A_B' 'Tone B','Tone A'}, 'FontSize', 16);
